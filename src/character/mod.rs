...
pub struct PlayerCharacterParams {
    ...
    #[serde(default = "PlayerCharacterParams::default_collider_size", with = "json::vec2_def")]
    ...
    #[serde(default = "PlayerCharacterParams::default_weapon_mount", with = "json::vec2_def")]
